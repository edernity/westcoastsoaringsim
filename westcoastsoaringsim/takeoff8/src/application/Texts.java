...
public class Texts {
    public static final String licenseInfo = "The artwork is licensed under a Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License, based on original work by Peter Spear.\n"
	+ "Polar Data came from XFLR5 Foil analysis program, http://xflr5.sourceforge.net/xflr5.html.\n"
	+ "The foil and glider design came from the GNULAB2 work of Pere H. Casellas Laboratori d'envol,"
	+ "http://www.laboratoridenvol.com/projects/gnuLAB2/gnuLAB2.en.html";
	
    public static final String disclaimer = 
	"SAFETY WARNING: This work is only meant as a game and to design autopilot controllers in a playful manner.\n"
    + "If you want to learn soaring / gliding, consult a professional, certified school instead!";

    public static final String title = "West Coast Soaring Sim - Jump & Run Game";
}
